...
<body>
  ...
  <div id="login">
  <form id="login_form" action="segitiga.php" method="POST">
    <div class="field_container">
      <input type="text" placeholder="alas" name="alas">
    </div>

    <div class="field_container">
      <input type="text" placeholder="tinggi" name="tinggi">
      <button id="sign_in_button">
        <input type="submit" name="submit" value="hitung" class="button_text">
...
<?php
 if(isset($_POST['submit'])){
        ...
        echo "<div class='field_container'>
              <input type='text' placeholder='hasilnya adalah' name='hasil' value='$Luas_segitiga' disabled>
              </div>";
